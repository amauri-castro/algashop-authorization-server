...
import com.algashop.authorizationserver.infrastructure.security.query.AuthUserClientScopesQueryService;
...
public class JdbcAuthUserClientScopesQueryService implements AuthUserClientScopesQueryService {
    ...
    @Override
    public Set<String> findAllowedScopesByRoleAndClientId(AuthUserType role, String clienteId) {
        return new HashSet<>(
                jdbcOperations.queryForList(SQL, String.class, role.name(), clienteId)
        );
    }
}
