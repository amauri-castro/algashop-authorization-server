package com.algashop.authorizationserver.infrastructure.security.code;
...
import com.algashop.authorizationserver.infrastructure.security.query.ClientAllowedQueryService;
import com.algashop.authorizationserver.infrastructure.security.token.ScopePolicyService;
...
public class AuthUserClientAccessPolicyValidator
    ...
    public void accept(OAuth2AuthorizationCodeRequestAuthenticationContext context) {
        ...
        if (!canUserClient(authUser.getType(), clientId)) {
    ...
    private Set<String> getUnauthorizedScopes(
        ...
        Set<String> filteredScopes = scopePolicyService
                .resolveScopes(type, authentication.getClientId(), originalScopes);
    ...
    private boolean canUserClient(AuthUserType type, String clientId) {
